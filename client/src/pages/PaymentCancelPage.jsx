              ...
              <div className="card shadow-sm border-0 rounded-4">
                <div className="card-body p-5 text-center">
                  <div className="mb-4 text-warning">
                    <i className="bi bi-exclamation-circle-fill" style={{ fontSize: "80px" }}></i>
                  </div>
                  <h2 className="fw-bold mb-3">Payment Cancelled</h2>
                  <p className="text-muted mb-4">Your payment process was cancelled before completion. No charges were made to your account.</p>
                  ...
                  <div className="d-grid gap-2 d-sm-flex justify-content-sm-center mt-4">
                    <Link to="/cart" className="btn btn-primary px-4 py-2 rounded-3 fw-medium">
                      Return to Cart
                    </Link>
