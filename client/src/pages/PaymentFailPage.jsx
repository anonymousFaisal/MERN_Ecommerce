              ...
              <div className="card shadow-sm border-0 rounded-4">
                <div className="card-body p-5 text-center">
                  <div className="mb-4 text-danger">
                    <i className="bi bi-x-circle-fill" style={{ fontSize: "80px" }}></i>
                  </div>
                  <h2 className="fw-bold mb-3">Payment Failed!</h2>
                  <p className="text-muted mb-4">
                    Unfortunately, your payment could not be processed. Please check your payment details or try a different payment method.
                  </p>
